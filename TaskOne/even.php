...
{
if($_POST['num1']%2==0)
    $message="<div class='alert alert-success m-3 mx-auto w-50'> This Number is <b>Even</b> <div>";
else
$message="<div class='alert alert-danger m-3 mx-auto w-50'> This Number is <b>Odd</b><div>";
